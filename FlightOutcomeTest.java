...
public class FlightOutcomeTest extends TestCase
{
    //~ Fields ................................................................
    ...
    public void testDecisionEffects() {
        ...
        FlightOutcome dispatch = FlightOutcome.calculateOutcome(" DISPATCH ", flight);
    ...
    public void testFuelCostAndNoMutation() {
        Flight flight = flight();
        FlightOutcome enough = FlightOutcome.calculateOutcome("Add Fuel", flight);
        assertEquals(0, enough.getCashChange());
        assertFalse(enough.doesRoundEnd());
        flight.aircraft.fuelAmount = 499;
        FlightOutcome fuel = FlightOutcome.calculateOutcome("Add Fuel", flight);
